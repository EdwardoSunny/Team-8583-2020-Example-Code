...
public class SwerveInverseKinematics
{
	...
	public SwerveInverseKinematics(int moduleCount, List<Translation2d> modulePositionsRelativeToDriveCenter)
	{
	...
	public List<Translation2d> calculateModuleVelocities(Translation2d translationVector, double rotationMagnitude,
			Pose2d robotPose, boolean isFieldCentric)
	{
		if (isFieldCentric)
		{
		...
		{
			moduleDriveVectors.add(translationVector.translateBy(rotationVector.scale(rotationMagnitude)));
		}
		return moduleDriveVectors;
	}

	public List<Translation2d> calculateNormalizedModuleVelocities(Translation2d translationVector,
			double rotationMagnitude, Pose2d robotPose, boolean isFieldCentric)
	{
		return normalizeVectors(
				calculateModuleVelocities(translationVector, rotationMagnitude, robotPose, isFieldCentric), 1.0);
	}
	...
	public List<Rotation2d> calculateModuleRotationHeadingsAlignedToRotationVectors(Rotation2d rotationOffset)
	{
	...
	private List<Translation2d> normalizeVectors(List<Translation2d> vectors, double referenceMagnitude)
	{
