...
public class StatefulXboxController extends XboxController
{
	...
	{
		BUTTON_A(1), BUTTON_B(2), BUTTON_X(3), BUTTON_Y(4), BUMPER_LEFT(5), BUMPER_RIGHT(6), BUTTON_BACK(7),
		BUTTON_START(8), CENTER_CLICK_LEFT(9), CENTER_CLICK_RIGHT(10), TRIGGER_LEFT(-1), TRIGGER_RIGHT(-2), POV_0(-3),
		POV_90(-4), POV_180(-5), POV_270(-6);
